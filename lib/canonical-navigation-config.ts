...
const V2_EXTRAS: NavItem[] = [
  ...
  { key: 'visits-all', label: 'All Visits', href: '/visits', iconEmoji: '🚗', keywords: ['all', 'every'], type: 'submodule', parentLabel: 'Customer Visits', parentKey: 'visits' },
...
const V3_EXTRAS: NavItem[] = [
  ...
  { key: 'samples-new', label: 'New Requests', href: '/samples?status=New', iconEmoji: '🧪', keywords: ['new', 'request'], type: 'submodule', parentLabel: 'Sample Management', parentKey: 'samples' },
  ...
  { key: 'samples-revision', label: 'Revision', href: '/samples?status=Revision', iconEmoji: '🧪', keywords: ['revision', 'change'], type: 'submodule', parentLabel: 'Sample Management', parentKey: 'samples' },
  // V3 negotiations sub-modules
  { key: 'negotiations-active', label: 'Active', href: '/negotiations?status=Active', iconEmoji: '🤝', keywords: ['active', 'ongoing'], type: 'submodule', parentLabel: 'Negotiations', parentKey: 'negotiations' },
  ...
  { key: 'purchase-orders-new', label: 'New', href: '/purchase-orders?status=New', iconEmoji: '📋', keywords: ['new', 'created'], type: 'submodule', parentLabel: 'Purchase Orders', parentKey: 'purchase-orders' },
  ...
  { key: 'purchase-orders-approved', label: 'Approved', href: '/purchase-orders?status=Approved', iconEmoji: '📋', keywords: ['approved', 'confirmed'], type: 'submodule', parentLabel: 'Purchase Orders', parentKey: 'purchase-orders' },
  { key: 'purchase-orders-rejected', label: 'Rejected', href: '/purchase-orders?status=Rejected', iconEmoji: '📋', keywords: ['rejected', 'declined'], type: 'submodule', parentLabel: 'Purchase Orders', parentKey: 'purchase-orders' },
  { key: 'purchase-orders-closed', label: 'Closed', href: '/purchase-orders?status=Closed', iconEmoji: '📋', keywords: ['closed', 'completed'], type: 'submodule', parentLabel: 'Purchase Orders', parentKey: 'purchase-orders' },
  ...
  { key: 'documents-specs', label: 'Technical Specs', href: '/documents?type=TechnicalSpec', iconEmoji: '📄', keywords: ['spec', 'technical'], type: 'submodule', parentLabel: 'Documents', parentKey: 'documents' },
  { key: 'documents-nda', label: 'NDAs', href: '/documents?type=NDA', iconEmoji: '📄', keywords: ['nda', 'confidential'], type: 'submodule', parentLabel: 'Documents', parentKey: 'documents' },

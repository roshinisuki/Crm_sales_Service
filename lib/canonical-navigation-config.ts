...
const V1_ITEMS: NavItem[] = [
  ...
  { key: 'forecast', label: 'Forecast', href: '/forecast', iconEmoji: '🎯', keywords: ['forecast', 'revenue', 'sales target'], type: 'module' },
  // Sub-modules
  { key: 'leads-overview', label: 'Leads Overview', href: '/leads', iconEmoji: '👤', keywords: ['all leads', 'leads list', 'overview'], type: 'submodule', parentLabel: 'Leads', parentKey: 'leads' },
  { key: 'accounts-overview', label: 'Accounts Overview', href: '/customer-master', iconEmoji: '🏢', keywords: ['all accounts', 'accounts list', 'overview'], type: 'submodule', parentLabel: 'Accounts', parentKey: 'accounts' },
  { key: 'contacts-overview', label: 'Contacts Overview', href: '/contacts', iconEmoji: '📋', keywords: ['all contacts', 'contacts list', 'overview'], type: 'submodule', parentLabel: 'Contacts', parentKey: 'contacts' },
  { key: 'activities-overview', label: 'Activities Overview', href: '/activities', iconEmoji: '📞', keywords: ['all activities', 'activities list', 'overview'], type: 'submodule', parentLabel: 'Activities', parentKey: 'activities' },
  { key: 'tasks-overview', label: 'Tasks Overview', href: '/tasks', iconEmoji: '✅', keywords: ['all tasks', 'tasks list', 'overview'], type: 'submodule', parentLabel: 'Tasks', parentKey: 'tasks' },
  { key: 'follow-ups-overview', label: 'Follow Ups Overview', href: '/follow-up', iconEmoji: '🔔', keywords: ['all follow ups', 'followups list', 'overview'], type: 'submodule', parentLabel: 'Follow Ups', parentKey: 'follow-ups' },
  { key: 'pipeline-overview', label: 'Pipeline Overview', href: '/sales-pipeline/pipeline-list', iconEmoji: '📈', keywords: ['all opportunities', 'pipeline list', 'overview'], type: 'submodule', parentLabel: 'Sales Pipeline', parentKey: 'pipeline' },
  { key: 'quotations-overview', label: 'Quotation Overview', href: '/quotations', iconEmoji: '💰', keywords: ['all quotations', 'quotations list', 'overview'], type: 'submodule', parentLabel: 'Quotations', parentKey: 'quotations' },
  { key: 'forecast-overview', label: 'Forecast Overview', href: '/forecast', iconEmoji: '🎯', keywords: ['all forecast', 'forecast list', 'overview'], type: 'submodule', parentLabel: 'Forecast', parentKey: 'forecast' },
  ...
  { key: 'leads-followup', label: "Today's Follow-up", href: '/leads?status=TodayFollowUp', iconEmoji: '👤', keywords: ['followup today', 'due today'], type: 'submodule', parentLabel: 'Leads', parentKey: 'leads' },
  { key: 'leads-upcoming', label: "Upcoming Follow-ups", href: '/leads?status=UpcomingFollowUp', iconEmoji: '👤', keywords: ['upcoming', 'followup', 'due'], type: 'submodule', parentLabel: 'Leads', parentKey: 'leads' },
  ...
  { key: 'pipeline-qualified', label: 'Qualified', href: '/sales-pipeline/pipeline-list?tab=Qualified', iconEmoji: '📈', keywords: ['qualified', 'sql'], type: 'submodule', parentLabel: 'Sales Pipeline', parentKey: 'pipeline' },
  { key: 'pipeline-rg', label: 'Requirement Gathering', href: '/sales-pipeline/pipeline-list?tab=RequirementGathering', iconEmoji: '📈', keywords: ['requirement', 'gathering', 'rg'], type: 'submodule', parentLabel: 'Sales Pipeline', parentKey: 'pipeline' },
  { key: 'pipeline-meeting', label: 'Meeting Scheduled', href: '/sales-pipeline/pipeline-list?tab=MeetingScheduled', iconEmoji: '📈', keywords: ['meeting', 'demo', 'scheduled'], type: 'submodule', parentLabel: 'Sales Pipeline', parentKey: 'pipeline' },
  { key: 'pipeline-demo', label: 'Demo Conducted', href: '/sales-pipeline/pipeline-list?tab=DemoConducted', iconEmoji: '📈', keywords: ['demo', 'conducted'], type: 'submodule', parentLabel: 'Sales Pipeline', parentKey: 'pipeline' },
  { key: 'pipeline-overdue', label: 'Overdue', href: '/sales-pipeline/pipeline-list?tab=overdue', iconEmoji: '📈', keywords: ['overdue', 'stale'], type: 'submodule', parentLabel: 'Sales Pipeline', parentKey: 'pipeline' },
  { key: 'pipeline-rejected', label: 'Rejected', href: '/sales-pipeline/pipeline-list?tab=Rejected', iconEmoji: '📈', keywords: ['rejected', 'declined'], type: 'submodule', parentLabel: 'Sales Pipeline', parentKey: 'pipeline' },
  // Settings
...
const V2_EXTRAS: NavItem[] = [
  { key: 'rfq', label: 'RFQ', href: '/rfq', iconEmoji: '📄', keywords: ['rfq', 'request for quote', 'costing'], type: 'module' },
  ...
  { key: 'leads-duplicate', label: 'Duplicate', href: '/leads?status=Duplicate', iconEmoji: '👤', keywords: ['duplicate', 'copy'], type: 'submodule', parentLabel: 'Leads', parentKey: 'leads', variantMin: 2 },
  // V2 accounts extras
  { key: 'accounts-active', label: 'Active Accounts', href: '/customer-master?status=ActiveCustomer', iconEmoji: '🏢', keywords: ['active', 'customer'], type: 'submodule', parentLabel: 'Accounts', parentKey: 'accounts', variantMin: 2 },
  ...
  { key: 'contacts-finance', label: 'Finance Contacts', href: '/contacts?type=Finance', iconEmoji: '📋', keywords: ['finance', 'accounts'], type: 'submodule', parentLabel: 'Contacts', parentKey: 'contacts', variantMin: 2 },
  { key: 'contacts-management', label: 'Management Contacts', href: '/contacts?type=Management', iconEmoji: '📋', keywords: ['management', 'executive'], type: 'submodule', parentLabel: 'Contacts', parentKey: 'contacts', variantMin: 2 },
  ...
  { key: 'timeline', label: 'Timeline', href: '/timeline', iconEmoji: '🕐', keywords: ['timeline', 'history', 'chronological'], type: 'module', variantMin: 2 },
  // V2 visits sub-modules — status-based navigation with type filter
  { key: 'visits-overview', label: 'Visits Overview', href: '/visits', iconEmoji: '🚗', keywords: ['all visits', 'visits list', 'overview'], type: 'submodule', parentLabel: 'Customer Visits', parentKey: 'visits' },
  ...
  { key: 'visits-needs-review', label: 'Needs Review', href: '/visits?status=NEEDS_REVIEW', iconEmoji: '🚗', keywords: ['review', 'pending', 'stuck'], type: 'submodule', parentLabel: 'Customer Visits', parentKey: 'visits' },
  { key: 'visits-field', label: 'Field Visits', href: '/visits?visitType=field_visit', iconEmoji: '🚗', keywords: ['field', 'site', 'plant'], type: 'submodule', parentLabel: 'Customer Visits', parentKey: 'visits' },
  { key: 'visits-office', label: 'Office Visits', href: '/visits?visitType=office_visit', iconEmoji: '🚗', keywords: ['office', 'customer visit', 'inbound'], type: 'submodule', parentLabel: 'Customer Visits', parentKey: 'visits' },
  { key: 'visits-reports', label: 'Visit Reports', href: '/visits/reports', iconEmoji: '🚗', keywords: ['report', 'summary'], type: 'submodule', parentLabel: 'Customer Visits', parentKey: 'visits' },
  // V2 catalogue sub-modules
  { key: 'catalogue-overview', label: 'Catalogue Overview', href: '/catalogue', iconEmoji: '📦', keywords: ['all catalogue', 'catalogue list', 'overview'], type: 'submodule', parentLabel: 'Product Catalogue', parentKey: 'catalogue' },
  ...
  // V2 RFQ sub-modules
  { key: 'rfq-overview', label: 'RFQ Overview', href: '/rfq', iconEmoji: '📄', keywords: ['all rfq', 'rfq list', 'overview'], type: 'submodule', parentLabel: 'RFQ', parentKey: 'rfq' },
  { key: 'rfq-new', label: 'New RFQ', href: '/rfq?status=New', iconEmoji: '📄', keywords: ['new', 'request'], type: 'submodule', parentLabel: 'RFQ', parentKey: 'rfq' },
  { key: 'rfq-review', label: 'Under Review', href: '/rfq?status=UnderReview', iconEmoji: '📄', keywords: ['review', 'pending'], type: 'submodule', parentLabel: 'RFQ', parentKey: 'rfq' },
  { key: 'rfq-costing', label: 'Costing Pending', href: '/rfq?status=CostingPending', iconEmoji: '📄', keywords: ['costing', 'price'], type: 'submodule', parentLabel: 'RFQ', parentKey: 'rfq' },
  { key: 'rfq-quotation', label: 'Quotation Created', href: '/rfq?status=QuotationCreated', iconEmoji: '📄', keywords: ['quotation', 'quote created'], type: 'submodule', parentLabel: 'RFQ', parentKey: 'rfq' },
  { key: 'rfq-closed', label: 'Closed RFQ', href: '/rfq?status=Closed', iconEmoji: '📄', keywords: ['closed', 'completed'], type: 'submodule', parentLabel: 'RFQ', parentKey: 'rfq' },
  // V2 quotations sub-modules
  ...
  { key: 'quotations-under-review', label: 'Under Review', href: '/quotations?status=UnderReview', iconEmoji: '💰', keywords: ['review', 'negotiation'], type: 'submodule', parentLabel: 'Quotations', parentKey: 'quotations', variantMin: 3 },
  ...
  { key: 'quotations-expired', label: 'Expired', href: '/quotations?status=Expired', iconEmoji: '💰', keywords: ['expired', 'timed out'], type: 'submodule', parentLabel: 'Quotations', parentKey: 'quotations', variantMin: 3 },
  // V2 deals sub-modules
  ...
  { key: 'reports-sales', label: 'Sales Performance Report', href: '/reports/sales-performance', iconEmoji: '📑', keywords: ['sales', 'performance'], type: 'submodule', parentLabel: 'Reports', parentKey: 'reports' },
  ...
  { key: 'reports-forecast', label: 'Forecast Report', href: '/reports/forecast', iconEmoji: '📑', keywords: ['forecast', 'revenue'], type: 'submodule', parentLabel: 'Reports', parentKey: 'reports' },
  // V2 forecast sub-modules
  { key: 'forecast-revenue', label: 'Revenue Forecast', href: '/forecast?type=Revenue', iconEmoji: '🎯', keywords: ['revenue', 'sales'], type: 'submodule', parentLabel: 'Forecast', parentKey: 'forecast' },
  { key: 'forecast-opportunity', label: 'Opportunity Forecast', href: '/forecast?type=Opportunity', iconEmoji: '🎯', keywords: ['opportunity', 'deal'], type: 'submodule', parentLabel: 'Forecast', parentKey: 'forecast' },
  { key: 'forecast-sales', label: 'Sales Forecast', href: '/forecast?type=Sales', iconEmoji: '🎯', keywords: ['sales', 'revenue'], type: 'submodule', parentLabel: 'Forecast', parentKey: 'forecast' },
  { key: 'forecast-target', label: 'Target vs Achievement', href: '/forecast/target-vs-achievement', iconEmoji: '🎯', keywords: ['target', 'achievement'], type: 'submodule', parentLabel: 'Forecast', parentKey: 'forecast' },
  // V2 settings
...
const V3_EXTRAS: NavItem[] = [
  ...
  { key: 'negotiations', label: 'Negotiations', href: '/negotiations', iconEmoji: '🤝', keywords: ['negotiation', 'negotiate', 'deal terms'], type: 'module' },
  { key: 'purchase-orders', label: 'Purchase Orders', href: '/purchase-orders', iconEmoji: '📋', keywords: ['po', 'purchase order', 'order'], type: 'module' },
  { key: 'approvals', label: 'Approval Center', href: '/approvals', iconEmoji: '✔️', keywords: ['approval', 'approve', 'pending approval'], type: 'module' },
  { key: 'documents', label: 'Documents', href: '/documents', iconEmoji: '📄', keywords: ['document', 'file'], type: 'module' },
  // V3 samples sub-modules
  { key: 'samples-overview', label: 'Sample Overview', href: '/samples', iconEmoji: '🧪', keywords: ['all samples', 'samples list', 'overview'], type: 'submodule', parentLabel: 'Sample Management', parentKey: 'samples' },
  ...
  { key: 'negotiations-overview', label: 'Negotiation Overview', href: '/negotiations', iconEmoji: '🤝', keywords: ['all negotiations', 'negotiations list', 'overview'], type: 'submodule', parentLabel: 'Negotiations', parentKey: 'negotiations' },
  { key: 'negotiations-active', label: 'Active Negotiation', href: '/negotiations?status=Active', iconEmoji: '🤝', keywords: ['active', 'ongoing'], type: 'submodule', parentLabel: 'Negotiations', parentKey: 'negotiations' },
  { key: 'negotiations-price', label: 'Price Revision', href: '/negotiations?status=PriceRevision', iconEmoji: '🤝', keywords: ['price', 'revision'], type: 'submodule', parentLabel: 'Negotiations', parentKey: 'negotiations' },
  { key: 'negotiations-commercial', label: 'Commercial Discussion', href: '/negotiations?status=CommercialDiscussion', iconEmoji: '🤝', keywords: ['commercial', 'terms'], type: 'submodule', parentLabel: 'Negotiations', parentKey: 'negotiations' },
  { key: 'negotiations-approval', label: 'Pending Approval', href: '/negotiations?status=PendingApproval', iconEmoji: '🤝', keywords: ['approval', 'pending'], type: 'submodule', parentLabel: 'Negotiations', parentKey: 'negotiations' },
  { key: 'negotiations-won', label: 'Won', href: '/negotiations?status=Won', iconEmoji: '🤝', keywords: ['won', 'successful'], type: 'submodule', parentLabel: 'Negotiations', parentKey: 'negotiations' },
  { key: 'negotiations-lost', label: 'Lost', href: '/negotiations?status=Lost', iconEmoji: '🤝', keywords: ['lost', 'failed'], type: 'submodule', parentLabel: 'Negotiations', parentKey: 'negotiations' },
  ...
  { key: 'approvals-po', label: 'PO Approvals', href: '/approvals?type=PO', iconEmoji: '✔️', keywords: ['po', 'purchase order'], type: 'submodule', parentLabel: 'Approval Center', parentKey: 'approvals' },
  // V3 documents sub-modules
  { key: 'documents-overview', label: 'Documents Overview', href: '/documents', iconEmoji: '📄', keywords: ['all documents', 'documents list', 'overview'], type: 'submodule', parentLabel: 'Documents', parentKey: 'documents' },
  { key: 'documents-drawings', label: 'Drawings', href: '/documents?type=Drawing', iconEmoji: '📄', keywords: ['drawing', 'technical'], type: 'submodule', parentLabel: 'Documents', parentKey: 'documents' },
  { key: 'documents-specs', label: 'Technical Specifications', href: '/documents?type=TechnicalSpec', iconEmoji: '📄', keywords: ['spec', 'technical'], type: 'submodule', parentLabel: 'Documents', parentKey: 'documents' },
  { key: 'documents-nda', label: 'NDA', href: '/documents?type=NDA', iconEmoji: '📄', keywords: ['nda', 'confidential'], type: 'submodule', parentLabel: 'Documents', parentKey: 'documents' },
  { key: 'documents-quotations', label: 'Quotations', href: '/documents?type=Quotation', iconEmoji: '📄', keywords: ['quotation', 'quote'], type: 'submodule', parentLabel: 'Documents', parentKey: 'documents' },
  { key: 'documents-pos', label: 'Purchase Orders', href: '/documents?type=PurchaseOrder', iconEmoji: '📄', keywords: ['po', 'purchase order'], type: 'submodule', parentLabel: 'Documents', parentKey: 'documents' },
  { key: 'documents-agreements', label: 'Agreements', href: '/documents?type=Agreement', iconEmoji: '📄', keywords: ['agreement', 'contract'], type: 'submodule', parentLabel: 'Documents', parentKey: 'documents' },
  { key: 'documents-brochures', label: 'Brochures', href: '/documents?type=Brochure', iconEmoji: '📄', keywords: ['brochure', 'marketing'], type: 'submodule', parentLabel: 'Documents', parentKey: 'documents' },
  // V3 reports extras
  { key: 'reports-samples', label: 'Sample Report', href: '/reports/samples', iconEmoji: '📑', keywords: ['sample', 'test'], type: 'submodule', parentLabel: 'Reports', parentKey: 'reports' },
  ...
  { key: 'reports-po', label: 'Purchase Order Report', href: '/reports/purchase-orders', iconEmoji: '📑', keywords: ['po', 'purchase order'], type: 'submodule', parentLabel: 'Reports', parentKey: 'reports' },
  { key: 'reports-po-conversion', label: 'PO Conversion Report', href: '/reports/po-conversion', iconEmoji: '📑', keywords: ['conversion', 'rate'], type: 'submodule', parentLabel: 'Reports', parentKey: 'reports' },
  // V3 settings

...
import { createUserByAdmin, resendInvitation } from "@/app/actions/auth";
                      ...
                      <div className="flex items-center justify-end gap-2">
                        {u.isFirstLogin && (
                          <button
                            ...
                            className="text-xs font-semibold text-amber-700 hover:underline px-3 py-1.5 rounded-lg bg-amber-50 hover:bg-amber-100 transition-colors border border-amber-200"
                          >
                            Resend Invite
                          </button>
                        )}

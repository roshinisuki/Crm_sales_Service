          ...
          <tbody>
            ...
            : visits.map((v: any) => (
              <tr key={v.id} className="border-b border-slate-100 hover:bg-slate-50/50">
                ...
                <td className="px-4 py-3 text-right"><button onClick={() => router.push(`/visits/${v.id}`)} className="p-1.5 rounded-lg hover:bg-slate-100 text-slate-600 cursor-pointer"><Ico d={icons.eye} size={15} /></button></td>
              </tr>
            ))}
          </tbody>
        </table>

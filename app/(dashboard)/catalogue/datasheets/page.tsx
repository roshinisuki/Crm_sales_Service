...
import {
  Search, Pencil, Trash2, FileText, UploadCloud,
      ...
      <div className="w-[320px] lg:w-[400px] xl:w-[450px] shrink-0 border-r border-border flex flex-col bg-page-bg relative">
        <div className="p-4 border-b border-border flex flex-col gap-3 shrink-0">
          <div className="flex items-center justify-between">
            ...
            <button onClick={openAddModal} className="p-1.5 bg-[var(--primary)] text-white rounded-lg hover:bg-[var(--primary-hover)] transition-colors" title="Add Datasheet">
              <Plus size={16} />
            </button>
          </div>
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden">
          {loading ? (
            <div className="p-6 text-center text-text-muted text-sm">Loading datasheets...</div>
          ) : docs.length === 0 ? (
            <div className="p-6 text-center flex flex-col items-center">
              <div className="w-12 h-12 rounded-xl bg-border-subtle flex items-center justify-center mb-2">
                <FileText size={24} className="text-text-muted" />
              </div>
              <p className="text-sm font-semibold text-text-primary">No datasheets found</p>
              <p className="text-xs text-text-muted mt-1 text-center">Upload your first product datasheet.</p>
            </div>
          ) : (
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-card overflow-hidden">
        {isModalOpen ? (
            ...
            <div className="flex items-center justify-between p-4 border-b border-border bg-page-bg shrink-0">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-base font-semibold text-text-primary">
                  {formData.id ? "Edit Datasheet" : "Add New Datasheet"}
                </h2>
              </div>
              <div className="flex items-center gap-2">
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
            ...
            <h2 className="text-lg font-semibold text-text-primary">Select a Datasheet</h2>
            <p className="text-sm text-text-muted max-w-sm mt-2">
              Choose a datasheet from the list to view or edit its details, or upload a new one.
            </p>
          </div>
        )}
      </div>

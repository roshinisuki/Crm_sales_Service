...
export async function GET(request: NextRequest) {
  ...
  const guard = enforceModuleGuard(user, MODULE_KEYS.NEGOTIATION, "GET /api/negotiations");
...
export async function POST(request: NextRequest) {
  ...
  const guard = enforceModuleGuard(user, MODULE_KEYS.NEGOTIATION, "POST /api/negotiations");
  if (guard) return guard;

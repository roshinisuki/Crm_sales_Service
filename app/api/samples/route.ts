...
export async function GET(request: NextRequest) {
  ...
  const guard = enforceModuleGuard(user, MODULE_KEYS.SAMPLE_MANAGEMENT, "GET /api/samples");
...
export async function POST(request: NextRequest) {
  ...
  const guard = enforceModuleGuard(user, MODULE_KEYS.SAMPLE_MANAGEMENT, "POST /api/samples");
  if (guard) return guard;
